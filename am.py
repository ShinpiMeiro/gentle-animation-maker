...
class Params_Window(QWidget):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_background.setText(
            _translate("MainWindow", "Choose your background (ratio - 16:9) (.png .jpg) file:"))
    ...
    def animate(self):
        if self.background_path:
            os.system(
                f'main.py True {self.audio_path[0]} {self.transcription_path[0]} {json_path} {self.background_path[0]}')
        else:
